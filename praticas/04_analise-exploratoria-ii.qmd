...
estatisticas_descritivas <- dados_cetesb |>
  ...
  summarise(
    ...
    media_ictem = mean(ictem),
    mediana_ictem = median(ictem),
    desvio_padrao_ictem = sd(ictem)
  )

reactable::reactable(estatisticas_descritivas)
```
...
```{r}
#| eval: false
write_csv(estatisticas_descritivas, "dados/estatisticas-descritivas-ugrhi.csv")

writexl::write_xlsx(estatisticas_descritivas, "dados/estatisticas-descritivas-ugrhi.xlsx")
```
